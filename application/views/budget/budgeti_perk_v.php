    ...
    var TableEditable = function () {
        ...
        var handleTable = function () {
            ...
            function editRow(oTable, nRow) {
                ...
                jqTds[0].innerHTML = '<input type="text" class="form-control input-small input-sm" value="' + aData[0] + '">';
                for(var i=1;i<=12;i++){
